...
const Header = () => {
  ...
  return (
    <div className=" font-mono absolute w-full px-8 py-2 bg-gradient-to-b from-black/75  z-20 flex justify-between">
      <div className="origin-left scale-[0.8]">
        <img
          className="w-48 ml-9 mr-6 mt-3.5 scale-[1.07] origin-top "
          src={LOGO}
          alt="nfLOGO"
        />
      </div>
      {user && (
        <div className="flex my-3 origin-right scale-[0.8]">
          ...
          <button
            ...
            className="backdrop-blur-3xl bg-white/60 rounded-lg font-bold text-md mx-4 px-5 h-[48px] text-black "
          >
            Sign Out
          </button>
        </div>
